...
class ModelExtensionPurpletreeMultivendorSellerproduct extends Model{
	   ////// quick order //////
		...
		public function addProduct($data) {
            ...
            $this->getProductSeoUrlsNew($product_id);
        ...
        protected function getProductSeoUrlsNew($product_id) {
            $query_url = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE query = 'product_id=" . (int)$product_id . "'");
