...
//		var_dump($order_info);
		...
		$html .= '</head><body>';
			...
			$html .= '<p>Поставщик: ООО "СТРУЧАЕВ ГРУПП", в лице Генерального директора Стручаева Виктора Васильевича, действующего на основании Устава и<br>';
