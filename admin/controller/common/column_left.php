...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/reviews')) {
				$catalog[] = array(
					'name'	   => 'Заявки',
					'href'     => $this->url->link('catalog/reviews', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
            ...
            if ($this->user->hasPermission('access', 'catalog/vacancy')) {
				$catalog[] = array(
					'name'	   => 'Вакансии',
            ...
            if ($this->user->hasPermission('access', 'catalog/paragraph3')) {		
		        $catalog[] = array(
			        'name'	   => $this->language->get('text_paragraph3'),
			        'href'     => $this->url->link('catalog/paragraph3', 'user_token=' . $this->session->data['user_token'], true),
			        'children' => array()		
		        );					
	        }
			...
			if ($this->user->hasPermission('access', 'sale/pact')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_order_pact'),
					'href'     => $this->url->link('sale/pact', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'customer/customer')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_customer_list'),
