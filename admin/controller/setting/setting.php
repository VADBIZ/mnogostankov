...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_ur'])) {
			$data['config_ur'] = $this->request->post['config_ur'];
		} else {
			$data['config_ur'] = $this->config->get('config_ur');
		}
      ...
      if (isset($this->request->post['config_textv'])) {
		...
		if (isset($this->request->post['config_meta_copy'])) {
			$data['config_meta_copy'] = $this->request->post['config_meta_copy'];
		} else {
			$data['config_meta_copy'] = $this->config->get('config_meta_copy');
		}
		...
		if (isset($this->request->post['config_meta_footer'])) {
			$data['config_meta_footer'] = $this->request->post['config_meta_footer'];
		} else {
			$data['config_meta_footer'] = $this->config->get('config_meta_footer');
		}
		...
		if (isset($this->request->post['config_image2'])) {
			$data['config_image2'] = $this->request->post['config_image2'];
		} else {
			$data['config_image2'] = $this->config->get('config_image2');
		}

        if (isset($this->request->post['config_contact'])) {
            $data['config_contacts'] = $this->request->post['config_contact'];
        } elseif ($this->config->get('config_contact')) {
            $data['config_contacts'] = $this->config->get('config_contact');
        } else {
            $data['config_contacts'] = array();
        }

        if (isset($this->request->post['config_requisite'])) {
            $data['config_requisites'] = $this->request->post['config_requisite'];
        } elseif ($this->config->get('config_requisite')) {
            $data['config_requisites'] = $this->config->get('config_requisite');
        } else {
            $data['config_requisites'] = array();
        }
		...
		if (isset($this->request->post['config_ib_title'])) {
			$data['config_ib_title'] = $this->request->post['config_ib_title'];
		} else {
			$data['config_ib_title'] = $this->config->get('config_ib_title');
		}

		if (isset($this->request->post['config_ib_text'])) {
			$data['config_ib_text'] = $this->request->post['config_ib_text'];
		} else {
			$data['config_ib_text'] = $this->config->get('config_ib_text');
		}

		if (isset($this->request->post['config_ib_button'])) {
			$data['config_ib_button'] = $this->request->post['config_ib_button'];
		} else {
			$data['config_ib_button'] = $this->config->get('config_ib_button');
		}
		...
		if (isset($this->request->post['config_image2']) && is_file(DIR_IMAGE . $this->request->post['config_image2'])) {
			$data['thumb2'] = $this->model_tool_image->resize($this->request->post['config_image2'], 100, 100);
		} elseif ($this->config->get('config_image2') && is_file(DIR_IMAGE . $this->config->get('config_image2'))) {
			$data['thumb2'] = $this->model_tool_image->resize($this->config->get('config_image2'), 100, 100);
		} else {
		...
		if (isset($this->request->post['config_index_banner'])) {
			$data['config_index_banner'] = $this->request->post['config_index_banner'];
		} else {
			$data['config_index_banner'] = $this->config->get('config_index_banner');
		}
		...
		if (isset($this->request->post['config_index_banner']) && is_file(DIR_IMAGE . $this->request->post['config_index_banner'])) {
			$data['index_banner'] = $this->model_tool_image->resize($this->request->post['config_index_banner'], 100, 100);
		} elseif ($this->config->get('config_index_banner') && is_file(DIR_IMAGE . $this->config->get('config_index_banner'))) {
			$data['index_banner'] = $this->model_tool_image->resize($this->config->get('config_index_banner'), 100, 100);
		} else {
			$data['index_banner'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
