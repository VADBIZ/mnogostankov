...
class ModelUserUser extends Model {
	...
	public function getUserByManager($manager_id) {
		$query = $this->db->query("SELECT CONCAT(firstname, ' ', lastname) AS user FROM `" . DB_PREFIX . "user` WHERE user_id = '" . $this->db->escape($manager_id) . "'");
		if (isset($query->row["user"])) {
