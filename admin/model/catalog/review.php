...
class ModelCatalogReview extends Model {
	...
	public function editReviewStatus($reviews_id, $status) {
        $this->db->query("UPDATE " . DB_PREFIX . "reviews SET tip = '" . (int)$status . "' WHERE reviews_id = '" . (int)$reviews_id . "'");
	...
	public function getReviewz2($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "reviews ";
	...
	public function getTotalReviewz2($data = array()) {
