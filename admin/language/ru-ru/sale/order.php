...
$_['text_order_spec']          	 = 'Генерация договора';
...
$_['entry_whosign']              = 'ФИО с правом подписи';
...
$_['entry_order_manager']		 = 'Менеджер';
...
$_['entry_sublist']			 	 = 'Дополнительные поля списка';
$_['entry_sublist_add']			 = 'Добавить поле в список';

$_['entry_choose_company']		 = 'Выберите компанию клиента из списка';
...
$_['error_upload']				 = 'Ошибка загрузка файла!';

$_['text_none']					 = '-- Не выбрано --';

$_['entry_pact_type']		 	= 'Правило поставки';
$_['entry_pact_sign']		 	= 'Подписанный договор';
$_['entry_pact_number']			= 'Номер договора';
$_['entry_term_pay']		 	= 'Условия оплаты';
$_['entry_time_delivery']		= 'Срок поставки';

$_['success_upload']			= 'Успешно загрузили!';
$_['pact_sign_change']			= 'Изменить файл';


$_['button_createContract_title'] = 'Создать договор';
$_['entry_company_empty']			= "[Компания без названия]";

$_['button_view'] = 'Посмотреть заказ';
$_['button_order_download'] = 'Скачать договор';